...
# Load audio files
x, Fs = librosa.load('data/ambulance.wav', sr=16000)
y, Fs = librosa.load('data/ambulance_speech.wav', sr=16000)
...
sf.write('filter_output.wav', y-yhat, Fs, subtype='PCM_24')

# read original speech without noise
o, Fs = librosa.load('data/kennedy.wav', sr=16000)
