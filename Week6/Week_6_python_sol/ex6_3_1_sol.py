...
plt.stem(range(l), theta, linefmt = 'blue', markerfmt='bo', label='true vector', basefmt=" ")
plt.stem(range(l), sols_lasso,  linefmt = 'none', markerfmt='r.', label='lasso', basefmt=" ")
plt.stem(range(l), sols_ridge,  linefmt = 'none', markerfmt='g.', label='ridge', basefmt=" ")
plt.legend()
plt.grid()
plt.show()
# %%
